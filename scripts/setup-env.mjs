...
function renderEnv(values) {
  const sections = [
    ...
    ["MCP provider credentials", ["SLACK_BOT_TOKEN", "SLACK_SIGNING_SECRET", "GITHUB_TOKEN", "DATADOG_API_KEY", "DATADOG_APP_KEY", "PAGERDUTY_API_TOKEN", "JIRA_BASE_URL", "JIRA_EMAIL", "JIRA_API_TOKEN", "CONFLUENCE_BASE_URL", "CONFLUENCE_EMAIL", "CONFLUENCE_API_TOKEN", "PROMETHEUS_BASE_URL", "OTEL_COLLECTOR_URL", "KUBECONFIG_PATH"]],
